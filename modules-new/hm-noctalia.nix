{ config, ... }:
{
  flake.modules.homeManager.noctalia = { pkgs, lib, config, ... }: {
    ...
    in {
      ...
      settings = {
        ...
        audio = {
          cavaFrameRate = 60;
          externalMixer = "hyprpwcenter || pavucontrol";
          mprisBlacklist = [ ];
          preferredPlayer = "spotify,clapper,vlc,firefox-developer-edition,firefox,mpv";
