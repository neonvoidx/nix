    ...
    initContent =
      lib.mkBefore # bash
        ''
          ...
          # Configure zsh-vi-mode to not override bindings
          ...
          # fzf-tab configuration (must be before loading plugins)
          zstyle ':fzf-tab:complete:cd:*' fzf-preview 'lsd $realpath'
          zstyle ':fzf-tab:complete:__zoxide_z:*' fzf-preview 'lsd $realpath'
          zstyle ':fzf-tab:*' fzf-command fzf

          # Fix zsh-vi-mode breaking fzf-tab
          function zvm_after_lazy_keybindings_setup() {
            # Rebind fzf-tab after zsh-vi-mode loads lazy keybindings
